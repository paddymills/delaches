...
CREATE TABLE Members (
    ...
    ECard INTEGER,
    MemberType INTEGER REFERENCES MemberType(Id),
    MemberStatus INTEGER REFERENCES MemberStatus(Id),
    WorkFlag BOOLEAN,
    FirstName TEXT,
    LastName TEXT,
    Address1 TEXT,
...
INSERT INTO MemberType(Description)
VALUES ('Adult'),
('Junior'),
('Lifetime');
INSERT INTO MemberStatus(Description)
VALUES ('Active'),
('Inactive'),
('Deceased'),
('Deleted');
INSERT INTO DuesRates(MemberType, StartDate, Description, Amount)
VALUES(3, '1900-01-01', 'No Lifetime Dues', 0.0);
COMMIT;